...
git status - Muestra el estado del repositorio y cambios  
...
git remote -v - Muestra los repositorios remotos conectados  
git push -u origin master - Sube el proyecto a GitHub por primera vez  
